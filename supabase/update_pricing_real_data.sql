-- Basis - replace placeholder market_pricing_data with real figures from midrag.co.il
-- Safe to run as-is in Supabase SQL Editor (UPDATE, not CREATE - can be re-run anytime).
--
-- Sources (fetched Aug 2026):
--   driving_instructor: https://www.midrag.co.il/Content/Price/13572  (מחיר שיעור נהיגה)
--   dietitian:          https://www.midrag.co.il/Content/Price/6192   (דיאטניות - מחירים)
--   private_chef:       https://www.midrag.co.il/Content/Price/10566  (שף פרטי - מחיר)
--
-- Note: midrag gives one or two headline prices per profession, not a breakdown per
